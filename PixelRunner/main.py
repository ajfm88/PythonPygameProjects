...
def player_animation():
    ...
    if player_rect.bottom < 300: # display the jump surface when player is not on the floor
        ...
        player_index += 0.1 #Gently change from 0 to 1 so that the animation changes every two frames
...
# Snail
snail_frame_1 = pygame.image.load('PixelRunner\graphics\snail\snail1.png').convert_alpha()
snail_frame_2 = pygame.image.load('PixelRunner\graphics\snail\snail2.png').convert_alpha()
snail_frames = [snail_frame_1, snail_frame_2]
snail_frame_index = 0
snail_surf = snail_frames[snail_frame_index]

# Fly
fly_frame1 = pygame.image.load('PixelRunner\graphics\Fly\Fly1.png').convert_alpha()
fly_frame2 = pygame.image.load('PixelRunner\graphics\Fly\Fly2.png').convert_alpha()
...
player_index = 0 # We will use it later to pick either the 1st or 2nd walk surface.
player_jump = pygame.image.load('PixelRunner\graphics\Player\jump.png').convert_alpha()
